        ...
        <div style={{ position: 'relative' }}>
          ...
          <input
            ...
            style={{
              ...
              border: `1.5px solid ${localError ? 'var(--error)' : 'var(--border-light)'}`,
              borderRadius: '14px',
            ...
            onBlur={(e) => {
              e.currentTarget.style.borderColor = localError ? 'var(--error)' : 'var(--border-light)';
        ...
        <button
          ...
          onMouseEnter={(e) => {
            if (!isLoading) {
              ...
              e.currentTarget.style.boxShadow = '0 8px 25px var(--green-glow-strong)';
            }
          }}
          onMouseLeave={(e) => {
